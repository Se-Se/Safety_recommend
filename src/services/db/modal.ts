  ...
  objectStoresMeta: [
    ...
    },
    {
      ...
      storeSchema: [
        ...
        { name: 'theBusiness', keypath: 'theBusiness', options: { unique: false } },
        { name: 'theSystem', keypath: 'theSystem', options: { unique: false } },
        { name: 'theData', keypath: 'theData', options: { unique: false } },
        { name: 'theProperty', keypath: 'theProperty', options: { unique: false } },
